...
<script language="javascript" type="text/javascript" src="<?php echo BASE_URL;?>/public/template/js/flot-chart/excanvas.min.js"></script>
...
<!-- calendar -->
	<script type="text/javascript" src="<?php echo BASE_URL;?>/public/template/js/monthly.js"></script>
