...
<link rel="stylesheet" href="<?php echo BASE_URL;?>/public/template/css/morris.css" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="<?php echo BASE_URL;?>/public/template/css/monthly.css">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="<?php echo BASE_URL;?>/public/template/js/jquery2.0.3.min.js"></script>
<script src="<?php echo BASE_URL;?>/public/template/js/raphael-min.js"></script>
<script src="<?php echo BASE_URL;?>/public/template/js/morris.js"></script>
</head>
<body>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src=<?php echo BASE_URL;?>"/public/template/image/2.png">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="<?php echo BASE_URL?>/login/logout"><i class="fa fa-key"></i>Đăng xuất</a></li>
            </ul>
        </li>
